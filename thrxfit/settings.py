"""
Django settings for thrxfit project.
...
SECRET_KEY = 'django-insecure-)-!59m*^&6)#@hf#_7!ekh%8x(+88oed4(^z@0836ftt9-oqb%'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store_app.views.categories',  # custom context processor for categories
                'cart_app.context_processors.cart',  # custom context processor for cart
            ],
        },
    },
]

WSGI_APPLICATION = 'thrxfit.wsgi.application'
